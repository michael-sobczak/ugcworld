...
func _ready() -> void:
    ...
    grad.colors = PackedColorArray([Color(0, 1, 0, 1), Color(0, 1, 0, 0)])
...
func _create_texture() -> ImageTexture:
    ...
    for y in range(32):
        for x in range(32):
            ...
            img.set_pixel(x, y, Color(0.0, 1.0, 0.0, a))
