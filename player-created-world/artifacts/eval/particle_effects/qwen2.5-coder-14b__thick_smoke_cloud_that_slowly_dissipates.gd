...
func _ready() -> void:
    ...
    particles.amount = 128              # particle count
    particles.lifetime = 5.0            # seconds each particle lives
    ...
    grad.colors = PackedColorArray([Color(0.5, 0.5, 0.5, 1), Color(0.5, 0.5, 0.5, 0)])
